...
const ContentItem = ({ photo, dataSource = 'photography' }: Props) => {
    ...
    <>
      ...
      <div className="fixed inset-0 w-screen h-screen overflow-hidden bg-black">
        ...
        <Button
          as="link"
          href={`/${ds.id}`}
          className="absolute top-4 right-4 z-20 p-3 bg-black/50 hover:bg-black/70 rounded-full text-white transition-all border-0"
        ...
        {!showInfo && (
          <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 z-10">
            <button
              ...
              className="bg-black/50 hover:bg-black/70 text-white px-4 py-2 rounded-full text-sm flex items-center gap-2 transition-all cursor-pointer"
