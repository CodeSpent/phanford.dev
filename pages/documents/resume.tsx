  ...
  return (
    <>
      <MetaTags
        ...
        content={resume}
        title={resume.title}
        description={resume.description || `${resume.fileType?.toUpperCase() || 'Document'} by Patrick Hanford - ${resume.title}`}
        url={typeof window !== 'undefined' ? window.location.href : `https://phanford.dev/documents/resume`}
      />
