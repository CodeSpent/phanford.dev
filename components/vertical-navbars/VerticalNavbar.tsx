  ...
  },
  {
    ...
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
          d="M22 1H2a1 1 0 00-1 1v20a1 1 0 001 1h20a1 1 0 001-1V2a1 1 0 00-1-1zM2 0a2 2 0 00-2 2v20a2 2 0 002 2h20a2 2 0 002-2V2a2 2 0 00-2-2H2zm7.515 16.777L8.72 15.98a1 1 0 10-1.414 1.414l3.097 3.097a1 1 0 001.414 0l3.096-3.097a1 1 0 00-1.414-1.414l-1.09 1.09v-6.74a1 1 0 10-2 0v6.74l-1.09-1.09a1 1 0 10-1.414 1.414zM17 6a1 1 0 100 2h-4a1 1 0 100-2h4z"
          clipRule="evenodd"
        />
      </svg>
    ),
