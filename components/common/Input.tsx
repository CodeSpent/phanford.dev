...
export const ListBoxInput: React.FC<ListBoxInputProps> = ({ label, options, value,
                                                            onChange }) => {
  return (
    <div className="mb-5">
      <label className="block text-sm font-medium text-gray-400">{label}</label>
...
export const ComboBoxInput: React.FC<ComboBoxInputProps> = ({ label, options, placeholder
                                                              , value, onChange }) => {
  ...
  return (
    <div className="mb-5">
      ...
      <Combobox as="div" value={selectedFilters} multiple className="relative" onChange={setSelectedFilters}>
        ...
        {options.length > 0 && (
          <Combobox.Options className="text-gray-600 bg-gray-900 absolute z-10 mt-1 max-h-60 w-full overflow-auto
